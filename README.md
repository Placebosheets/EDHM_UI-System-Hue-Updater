...
*Change the hud to follow the colour of the powerplay state you’re in.*

*Make your radar or ship hologram warn you of your current system's security level.*

*Turn night vision into an analysis tool that alerts you to different faction states.* 
...
* The Galaxy map colour scheme informs the colour theme of the environmental HUD in each individual system.
* Select internal ship hub features are also given the same options.
* Different overall themes to choose from - ED Starmap, Bright, Dark, Vaporwave or a variable Orange theme (for default ED vibes) that all use the galaxy map colours as their core data source.
* Keep track of all the features of your current system and their corresponding colour codes in-app as you journey across the bubble.


## **Requirements**

Elite Dangerous: Odyssey and the latest version of EDHM_UI found [here](https://github.com/BlueMystical/EDHM_UI).
...
## **All suggestions welcome. Please steal and redistribute. Just wanted this in game. o7**
